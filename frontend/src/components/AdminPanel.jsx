...
function AdminPanel({ theme = "dark" }) {
  const colors = THEME_CONFIG[theme] || THEME_CONFIG.dark;
  ...
  const [newHospital, setNewHospital] = useState({ name: "", latitude: "", longitude: "", address: "" });
  ...
  const cancelEdit = () => { setEditHospital(null); setError(null); };
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <button
                ...
                style={{
                  ...btnStyle,
                  opacity: !newHospital.name.trim() || !newHospital.latitude || !newHospital.longitude ? 0.6 : 1,
                  cursor: !newHospital.name.trim() || !newHospital.latitude || !newHospital.longitude ? 'not-allowed' : 'pointer'
                }}
              >
          ...
          <div style={{
            ...
            {error && (
              <div style={{
                padding: '16px', color: '#ff4757', background: 'rgba(255,71,87,0.15)',
                borderRadius: '16px', border: '1px solid #ff4757', marginBottom: '18px',
                fontSize: isMobile ? '13px' : '15px'
              }}>
                ⚠️ {error}
              </div>
